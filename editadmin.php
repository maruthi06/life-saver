...
echo "<table border='1' align='center' style='border-collapse:collapse;border:'red';>
  <tr>
  <td align='center' style='color:brown'><i>Id</td>
    <td align='center' style='color:brown'><i>Name </td>
    ...
    <td style='color:brown'><i>Registered time</td>	
	</tr>";
  ...
  echo "<td align='center'>".$timestamp."</td>"."<br>";
  echo "</tr>"; 
     }
} 
else{
	echo "<h1 font size='20px' style='color:red' align='center'>!!!!No Donar found !!!!</h1>";
}
?>
...
<form  align="right" action="delete1.php">
