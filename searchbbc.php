...
<h1 align="center"><font color="red">SEARCH BY CITY</font></h1>
...
<form action="resc1.php" method="post">
<section><font color="white">City:<br></font></section>
<select name="city">
...
<form action="searchbb.php"><input type="submit" value="Back">
 </form>  
 </body>
 </html>